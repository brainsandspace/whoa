module.exports = {
  normative: `Test test. I should do this. Next sentence.`,
  redaction: `🕵{redact me and this is **bold**}`,
  revision: [
    `✍️{Some text that needs revising.}(A hint.)`,
    `✍️{Some text that needs revising.}`,
  ],
  ...
  **With the internet, you can see how everything works**, you just need to know where to look.
  ...
  <aside>Whole aside into taking screenshots of dev tools from dev tools, see [tweet](https://twitter.com/davvidbaker/status/923676617842610176),</aside>
